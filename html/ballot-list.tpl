        ...
        <div class="card card-gray-dark card-outline">
            <div class="card-header">
                ...
                <div class="card-tools d-none d-sm-inline-block">
                    <a href="/ballot" class="btn btn-lg bg-cp-purple text-white"><i class="fa fa-plus-square"></i> Nouvelle consultation</a>
                </div>
            </div>
...
{*                        <th>Nombre de questions</th>*}
                    ...
                    {foreach from=$ballot_list item=item key=key}
                        <tr>
                            <td><a href="/ballot?ballot_id={$item.ballot_id|intval}" class="btn btn-sm"><i class="fa fa-edit"></i></a></td>
...
{*                            <td>{$item.nb_question}</td>*}
                            ...
                            <td>
                                ...
                                <button class="btn-copy-shortcode btn btn-sm" data-toggle="tooltip" data-placement="top" title="Copier dans le Presse-papier"><i class="fa fa-copy"></i></button>
                                <input class="input-shortcode" type="text" value="{$smarty.env.APP_HOST}/{$item.ballot_shortcode|for_html}"/>
                            </td>
                            <td>
                                <button data-ballot_id="{$item.ballot_id|intval}" class="btn-remove btn btn-sm"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    {/foreach}
                    </tbody>
